...
Agreement v2.0, with the Foundation replaced by the copyright holder named
below. Only the party names differ from the Apache original.

You accept this agreement by signing it when the bot asks, on your first pull
request. Signing once covers everything you contribute to this repository from
then on.
...
authorising it. For a legal entity, that entity and all others controlling, or
controlled by, or under common control with it are treated as one.

**"Contribution"** means any original work of authorship, including any
modification of or addition to an existing work, that You intentionally submit
to the Owner for inclusion in, or documentation of, the Project. "Submitted"
means any form of electronic, verbal, or written communication sent to the
Owner or its representatives — including but not limited to communication on
issue trackers, pull requests, and mailing lists — excluding communication
conspicuously marked in writing as "Not a Contribution."

## 2. Grant of copyright licence

You retain all right, title and interest in Your Contributions. Subject to the
terms of this agreement, You grant to the Owner and to recipients of software
...
The right to sublicense is what allows the Owner to distribute the Project
under its current licence and to change that licence in future without
returning to every contributor for permission.

## 3. Grant of patent licence

You grant to the Owner and to recipients of software distributed by the Owner a
...
that licence applies only to those patent claims licensable by You that are
...
licences granted to that entity under this agreement for that Contribution or
Project terminate as of the date such litigation is filed.

## 4. You are entitled to grant this

You represent that You are legally entitled to grant the above licences. If
...
employer has executed a separate corporate agreement with the Owner.

## 5. Original work

You represent that each Contribution is Your original creation. You represent
that Your Contributions include complete details of any third-party licence or
